...
#ifndef IMUFILTER_AHRS_H
#define IMUFILTER_AHRS_H
...
class IMUFilter_AHRS : public IMUFilter
{
public:

    IMUFilter_AHRS();
    virtual ~IMUFilter_AHRS();
...
public:
    ...
    void getGravity(double& rx, double& ry, double& rz,
                    double gravity = 9.80665);
private:
    void ComputeFirstOrientation(double ax, double ay, double az);
};

#endif // IMUFILTER_AHRS_H
