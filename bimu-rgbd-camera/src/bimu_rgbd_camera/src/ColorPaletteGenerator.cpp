...
//double ColorPaletteGenerator::maxHueAngle = 240.0f;
int ColorPaletteGenerator::defaultAlpha = 255;
extern unsigned short *g_distance_table;
extern unsigned char *g_pzdTable[4096];
...
void ColorPaletteGenerator::DmColorMode14(RGBQUAD *palette,float zFar,float zNear)
{
    printf("%s\n", __func__);
